...
**Notifications** — opt-in, for new episodes, show premieres, movie releases, and two engagement reminders, requested from the same Settings row. Two delivery paths, layered:
